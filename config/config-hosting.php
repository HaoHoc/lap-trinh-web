<?php
// ============================================================
//  config.php — Cấu hình cho InfinityFree hosting
//  SAU KHI ĐIỀN PASSWORD → ĐỔI TÊN FILE NÀY THÀNH config.php
// ============================================================
if (defined('DB_HOST')) return;

define('DB_HOST',    'sql208.infinityfree.com');
define('DB_PORT',    3306);
define('DB_NAME',    'if0_41704666_db_name');
define('DB_USER',    'if0_41704666');
define('DB_PASS',    'Vthanhisme123@');  // ← Đổi cái này!
define('DB_CHARSET', 'utf8mb4');

define('APP_URL',         'http://pixcamphanvanhon.rf.gd');
